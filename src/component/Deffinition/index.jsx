...
export const Deffinition = () => {
    return(
        <section className="font-workSans bg-main -z-20 relative overflow-hidden pt-48 pb-12 md:pb-48 " aria-label="definition">
            ...
            <div className="flex flex-col translate-x-0 lg:translate-x-4 mx-auto gap-4 font-semibold text-right w-10/12 lg:w-5/12 mt-7" aria-label="definition-wrapper-text">
